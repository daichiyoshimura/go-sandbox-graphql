...
func (cc *CustomerCreate) AddFollowIDs(ids ...int) *CustomerCreate {
	cc.mutation.AddFollowIDs(ids...)
	return cc
}

// AddFollows adds the "follows" edges to the Account entity.
func (cc *CustomerCreate) AddFollows(a ...*Account) *CustomerCreate {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
...
func (cc *CustomerCreate) AddItemIDs(ids ...int) *CustomerCreate {
	cc.mutation.AddItemIDs(ids...)
	return cc
}

// AddItems adds the "items" edges to the Item entity.
func (cc *CustomerCreate) AddItems(i ...*Item) *CustomerCreate {
	ids := make([]int, len(i))
	for j := range i {
		ids[j] = i[j].ID
	}
