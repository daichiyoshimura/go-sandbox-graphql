...
func HasFollows() predicate.Customer {
...
func HasFollowsWith(preds ...predicate.Account) predicate.Customer {
	return predicate.Customer(func(s *sql.Selector) {
		step := newFollowsStep()
...
func HasItems() predicate.Customer {
	return predicate.Customer(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasItemsWith(preds ...predicate.Item) predicate.Customer {
	return predicate.Customer(func(s *sql.Selector) {
		step := newItemsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
